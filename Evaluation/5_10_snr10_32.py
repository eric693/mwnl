...
def do_test(input_data, encoder, decoder, normlize_layer, channel, len_batch):
    ...
    with torch.no_grad():
        ...
        # print("Float point convert bit vector :")
        ...
        # total_bits = pred1.numel()
        # calculated_BER = num_errors.item() / total_bits
        
        # print(f"Received Fixed Point with BER {BER_target}:\n{received_pred1}")
        # print(f"Total number of bits: {total_bits}")
        # print(f"Number of errors: {num_errors.item()}")
        # print(f"Calculated BER: {calculated_BER}")
        
        # Float point convert to bit vector
        pred1 = float_to_fixed_point_sign_5_5_6(output)
        print(f"Original Fixed Point:\n{pred1}")
        ...
        pred8 = fixed_point_to_float_sign_5_5_6(received_pred1, int_bits=13, frac_bits=6)
        print("Bit point convert float vector :")
        print(pred8)
        ...
        # output = decoder.sample_max_batch(output, None) #None
    ...
    # calculated_BER = total_errors / total_bits if total_bits > 0 else 0
    # print(f"Calculated BER: {calculated_BER}")
